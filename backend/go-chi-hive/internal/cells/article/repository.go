...
func (s *articleSchema) toDomain(tags []string) *Article {
	var image *string
...
func (r *repository) Create(ctx context.Context, article *Article, authorID int64) error {
...
func (r *repository) createTags(ctx context.Context, tx *sqlx.Tx, article *Article) error {
...
func (r *repository) GetBySlug(ctx context.Context, slug string, observerID *int64) (*Article, error) {
	return r.findOneBy(ctx, "slug", slug, observerID)
}

func (r *repository) GetByTitle(ctx context.Context, title string, observerID *int64) (*Article, error) {
	return r.findOneBy(ctx, "title", title, observerID)
}

func (r *repository) GetArticles(ctx context.Context, params GetArticlesQuery) ([]*Article, int, error) {
	queryBase := `
		FROM article a
	...
	articles := make([]*Article, len(schemas))
	for i, s := range schemas {
...
func (r *repository) GetFeed(ctx context.Context, userID int64, limit, offset int) ([]*Article, int, error) {
	query := `
		SELECT a.id, a.slug, a.title, a.description, a.body, a.fk_author, a.created_at, a.updated_at,
		       u.username, u.bio, u.image,
		       1 as following,
...
func (r *repository) Favorite(ctx context.Context, articleID, userID int64) error {
...
func (r *repository) Unfavorite(ctx context.Context, articleID, userID int64) error {
	_, err := r.db.ExecContext(ctx, `
...
func (r *repository) getTagsForArticles(ctx context.Context, articleIDs []int64) (map[int64][]string, error) {
	if len(articleIDs) == 0 {
...
func (r *repository) findOneBy(ctx context.Context, column string, value any, observerID *int64) (*Article, error) {
