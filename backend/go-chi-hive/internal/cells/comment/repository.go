...
func (r *repository) Create(ctx context.Context, comment *Comment, articleID, authorID int64) error {
	query := `
...
func (s *commentSchema) toDomain() Comment {
	var image *string
...
func (r *repository) GetByID(ctx context.Context, id int64) (*Comment, int64, int64, error) {
...
func (r *repository) FindByArticleID(ctx context.Context, articleID int64, observerID *int64) ([]Comment, error) {
	...
	comments := make([]Comment, len(schemas))
