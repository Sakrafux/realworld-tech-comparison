...
func (m *MockArticleService) GetArticles(ctx context.Context, query port.GetArticlesQuery) ([]*domain.Article, int, error) {
	args := m.Called(ctx, query)
	if args.Get(0) == nil {
...
func (m *MockArticleRepository) GetArticles(ctx context.Context, params port.GetArticlesQuery) ([]*domain.Article, int, error) {
